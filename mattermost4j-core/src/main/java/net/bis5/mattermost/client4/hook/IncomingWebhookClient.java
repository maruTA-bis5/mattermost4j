/*
 * @(#) net.bis5.mattermost.client4.hook.IncomingWebhookClient
...
public class IncomingWebhookClient implements IncomingWebhook {
	...
	public ApiResponse<Boolean> postByIncomingWebhook(IncomingWebhookRequest payload) {
		return ApiResponse.of(
				hookTarget.request(MediaType.TEXT_PLAIN_TYPE, MediaType.APPLICATION_JSON_TYPE)
						.method(HttpMethod.POST, Entity.json(payload)),
				Void.class).checkStatusOK();
	}
