/*
 * @(#) net.bis5.mattermost.model.config.consts.WebServerMode
...
public enum WebServerMode implements HasCode<WebServerMode> {
	...
	public static WebServerMode of(String code) {
		return Arrays.stream(values()).filter(e -> e.getCode().equals(code)).findFirst().orElse(REGULAR);
	}
	...
	public static class WebServerModeDeserializer extends JsonDeserializer<WebServerMode> {
		 ...
		 */
		@Override
		public WebServerMode deserialize(JsonParser p, DeserializationContext ctxt)
