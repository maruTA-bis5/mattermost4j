...
public enum Permission {
	...
	MANAGE_SLASH_COMMANDS("manage_slash_commands", "authentication.permissions.manage_slash_commands"), //
	MANAGE_OTHERS_SLASH_COMMANDS("manage_others_slash_commands",
			"authentication.permissions.manage_others_slash_commands"), //
	CREATE_PUBLIC_CHANNEL("create_public_channel", "authentication.permissions.create_public_channel"), //
	CREATE_PRIVATE_CHANNEL("create_private_channel", "authentication.permissions.create_private_channel"), //
	...
	ASSIGN_SYSTEM_ADMIN_ROLE("assign_system_admin_role", "authentication.permissions.assign_system_admin_role"), //
	...
	CREATE_DIRECT_CHANNEL("create_direct_channel", "authentication.permissions.create_direct_channel"), //
	...
	DELETE_PUBLIC_CHANNEL("delete_public_channel", "authentication.permissions.delete_public_channel"), //
	DELETE_PRIVATE_CHANNEL("delete_private_channel", "authentication_permissions.delete_private_channel"), //
	...
	PERMANENT_DELETE_USER("permanent_delete_user", "authentication.permissions.permanent_delete_user"), //
	...
	MANAGE_OTHER_WEBHOOKS("manage_others_webhooks", "authentication.permissions.manage_others_webhooks"), //
	MANAGE_OAUTH("manage_oauth", "authentication.permissions.manage?oauth"), //
	MANAGE_SYSTEM_WIDE_OAUTH("manage_sytem_wide_oauth", "authentication.permissions.manage_sytem_wide_oauth"), //
	...
	REMOVE_USER_FROM_TEAM("remove_user_from_team", "authentication.permissions.remove_user_from_team"), //
	...
	LIST_USERS_WITHOUT_TEAM("list_users_without_team", "authentication.permissions.list_users_without_team"), //
	;
