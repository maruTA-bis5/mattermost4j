...
import net.bis5.mattermost.model.config.consts.ChannelSidebarOrganization.ChannelSidebarOrganizationDeserializer;
...
public enum ChannelSidebarOrganization implements HasCode<ChannelSidebarOrganization> {
  ...
  public static ChannelSidebarOrganization of(String code) {
  ...
  public static class ChannelSidebarOrganizationDeserializer extends JsonDeserializer<ChannelSidebarOrganization> {
    @Override
    public ChannelSidebarOrganization deserialize(JsonParser p, DeserializationContext ctxt)
        throws IOException {
